Main_dir_hazirim='C:\Users\admin\Documents\Run_Matlab_Fast_Folder\Gather_Tfas_DATA_Many_Drives\Log_Tfas_drives_Run_23_10_21';
save_Main_dir_hazirim='C:\Users\admin\Documents\Run_Matlab_Fast_Folder\Tfas_log_triag';
...
%check if txt_filepeths is empty, if so, fix to add mu after point
       ...
       for ii=1:1:length(address)
        pivot1=load(TXT_filepaths{address(ii)}); 
        All_data=[All_data ;pivot1.A3_reduced];
       end
       All_data3=All_data;
