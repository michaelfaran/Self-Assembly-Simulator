...
mainname='06_20_2022_18_45_03_mu_1_Js__4_0_runs_3';
restoredefaultpath
...
%     o=beast(Total_energy, 'start', 0, 'tseg.min',floor(0.01*mimi(ii)),'season','none');
%  o=beast(Total_energy, 'start', 0, 'tseg.min',0.005*length(Total_energy),'season','none');
   %here take the new Y
...
%    oo=beast(o.trend.order, 'start', 0,'season','none');
 cp=sort(take_change_points(o.trend.cpOccPr,o.trend.ncp_median,floor(0.01*mimi(ii))));
...
%         end
    ...
    saveas(figure(gcf),fullfile(Main_dir_hazirim,mydir,'Energy Trajectories.png'));
% pop=median(mimi);
...
A_reduced3=A_reduced;
A_reduced5=C_reduced;

save('A3_reduced.mat','A3_reduced');
save('A5_reduced.mat','A5_reduced');
...
save('A5_redcued_PCA.mat','A5_reduced_PCA');
...
save('A3_redcued_PCA.mat','A3_reduced_PCA');
