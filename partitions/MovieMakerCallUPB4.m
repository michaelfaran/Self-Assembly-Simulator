%MoviemKaer
function v= MovieMakerCallUPB4(dir2,dir,a,name, name1,name2,energy,entropy,dist1,dist2,resolution,J_strong,Date,downsample,mu)
cd(dir);
yyyy=str2num(Date(3));
mm=str2num(Date(1));
dd=str2num(Date(2));
...
c1=xline(axes1,(k-1)*UPresolution,'--b');
c2=xline(axes2,(k-1)*UPresolution,'--b');
c3=xline(axes3,(k-1)*UPresolution,'--b');
c4=xline(axes4,(k-1)*UPresolution,'--b');
