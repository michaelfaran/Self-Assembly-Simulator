...
Main_dir_hazirim= 'C:\Users\admin\Documents\Run_Matlab_Fast_Folder\Tfas_triag';
cd(Main_dir_hazirim)
...
%     Iz(isnan(Iz))=round(meanz);
    ...
    d1=linspace(floor(mini1),ceil(maxi1),10);
    d2=linspace(floor(mini2),ceil(maxi2),10);
    d3=linspace(floor(mini3),ceil(maxi3),10);
